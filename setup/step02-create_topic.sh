...
main()
{
	...
	docker exec -it broker kafka-topics --bootstrap-server broker:29092 --create --topic my-stream-pyflink-output
	docker exec -it broker kafka-topics --bootstrap-server broker:29092 --create --topic my-stream-schema-json
...
#	docker exec -it broker kafka-topics --bootstrap-server broker:29092 --create --topic my-stream-wordcount-output
	...
	docker exec -it broker kafka-topics --bootstrap-server broker:29092 --create --topic my-cdc-mysql.mytest.user
}
# }}}
